...
const App = () => {
  ...
  return (
    ...
    style={tapado}>
      <div className="atras">
        <img src="https://png.pngtree.com/background/20210716/original/pngtree-gradient-halo-style-cream-background-picture-image_1360997.jpg" alt=""/>
      </div>  
    </div>)
    :
    (<div onClick={()=> marcar(index)} className="cuadro" key={index}
